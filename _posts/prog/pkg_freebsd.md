...
Пакет можно заблокировать чтобы он не обновлялся при автоматическом обновлении всех пакетов. Это удобно если несколько приложений собираются из портов с необходимыми опциями.Заблокируем например пакет php82 от любых действий с ним
