---
layout: post
title:  Pkg - это пакетный менеджер для FreeBSD
categories: Программы
---

*Список репозиториев находится в файле /etc/pkg/FreeBSD.conf*
...
#### Обновление установленных пакетов(Обновляем репозиторий пакетов)
...
#### Найти пакет в репозитории и доступные его версии для установки
...
#### Блокировка и разблокировка пакета

Пакет можно заблокировать чтобы он не обновлялся при автоматическом обновлении всех пакетов.

Это удобно если несколько приложений собираются из портов с необходимыми опциями.

Заблокируем например пакет nano от любых действий с ним
