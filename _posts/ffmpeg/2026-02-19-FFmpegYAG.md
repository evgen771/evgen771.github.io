...
![](/assets/ffmpeg/ffmpeg_windows.jpg)
...
![Выбор запуска(второй пункт это установленная FFmpeg в Windows)](/assets/ffmpeg/ffmpegYAG_play.jpg)

#### Ну и сама программа. Думаю никаких сложностей не будет!

![Ну и сама программа. Думаю никаких сложностей не будет!](/assets/ffmpeg/ffmpegYAG_play_2.jpg)
