...
![](/assets/ffmpeg/ffmpeg_windows.png)
...
![Выбор запуска(второй пункт это установленная FFmpeg в Windows)](/assets/ffmpeg/ffmpegYAG_play.png)

#### Ну и сама программа. Думаю никаких сложностей не будет!

![Ну и сама программа. Думаю никаких сложностей не будет!](/assets/ffmpeg/ffmpegYAG_play_2.png)
