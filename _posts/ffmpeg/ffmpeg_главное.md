...
```
global_options — параметры, которые применяются ко всей операции (например, уровень логгирования)

input_file_options — параметры, которые относятся к входному файлу (кодеки, фильтры и т. д.)

-i input_url — входной файл (можно указать несколько файлов)

output_file_options — параметры, которые применяются к выходному файлу (кодеки, фильтры и т. д.)

output_url — выходной файл.
```
