...
<a href="/assets/other/arch_wifi.jpg" target="_blank">
    <img src="/assets/other/arch_wifi.jpg" alt="arch_wifi">
</a>
...
Если wifi то так(изображение прикреплю, правда снимок сделан не мной, но актуален):
...
grub-install —target=x86_64-efi —efi-directory=/boot —bootloader-id=GRUB(— это двойное тире)
```
#### Создать конфиг:
