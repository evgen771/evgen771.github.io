---
layout: post
title: LaTeX. Кликабельные ссылки в документе.
categories: LaTeX
---
...
Метка автоматически связывается с текущим значением счетчика страниц и, в зависимости от контекста, счетчика формул, рисунков и т. д. 
...
![](/assets/latex/format2.png)

*Код; результат:*

![](/assets/latex/1-links.png)![](/Files/latex/2-links.png)
...
![](/assets/latex/images_figures_latex.jpg)
...
![](/assets/latex/degress_test.png)

![](/assets/latex/degrees.png)