...
* Маркированный: \begin{itemize} \item Текст \end{itemize}
* Нумерованный: \begin{enumerate} \item Текст \end{enumerate}

## 4. Математика (нужен \usepackage{amsmath})
...
## 6. Работа с пакетом draftwatermark
...
## 2. Изображения (пакет graphicx)
В преамбуле: \usepackage{graphicx}.
В тексте:
...
## 5. Поля и отступы (пакет geometry)
В преамбуле для настройки границ страницы:

\usepackage[left=2cm, right=1.5cm, top=2cm, bottom=2cm]{geometry}

## 6. Команды draftwatermark (для управления из текста)
...
------------------------------
Лайфхак для таблиц: Чтобы не мучиться с кодом вручную, используйте онлайн-сервис TablesGenerator.com — там можно нарисовать таблицу как в Excel и просто скопировать готовый код для $\text{\LaTeX}$.
