...
- [Изменить размер изображения](#изменить-размер-изображения)
- [Сжать изображение по ширине до 100px](#сжать-изображение-по-ширине-до-100px)
- [Сжать изображение по высоте до 150px](#сжать-изображение-по-высоте-до-150px)
- [Изменение размера изображения без сохранения соотношения сторон](#изменение-размера-изображения-без-сохранения-соотношения-сторон)
- [Изменение размера изображения в процентах](#изменение-размера-изображения-в-процентах)
- [Поворот изображения](#поворот-изображения)
- [Конвертирование в другой формат](#конвертирование-в-другой-формат)
- [Качество \*.jpg](#качество-jpg)
- [Практическое применение некоторых возможностей пакета](#практическое-применение-некоторых-возможностей-пакета)
- [Создание анимации](#создание-анимации)
- [Различия между двумя изображениями](#различия-между-двумя-изображениями)
- [Наложение одного изображения на другое](#наложение-одного-изображения-на-другое)
- [Вывод изображения на экран](#вывод-изображения-на-экран)
- [Информация об изображении](#информация-об-изображении)
- [Создание скриншота](#создание-скриншота)
- [Изменение разрешения изображения](#изменение-разрешения-изображения)
- [Изменение разрешения в процентах](#изменение-разрешения-в-процентах)
- [Изменения разрешения относительно старого разрешения.](#изменения-разрешения-относительно-старого-разрешения)
- [Кадрирование изображения](#кадрирование-изображения)
- [Изменить глубину цвета](#изменить-глубину-цвета)
- [Склейка изображений в единое](#склейка-изображений-в-единое)
- [Добавление цветной рамки вокруг изображения](#добавление-цветной-рамки-вокруг-изображения)
- [Поворот изображения](#поворот-изображения-1)
