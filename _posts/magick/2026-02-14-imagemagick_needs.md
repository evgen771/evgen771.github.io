...
- [Изменение размера изображения до 100×100 пикселей без учета соотношения сторон](#изменение-размера-изображения-до-100100-пикселей-без-учета-соотношения-сторон)
- [Качество](#качество)
