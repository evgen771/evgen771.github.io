...
#### Открыть терминал, где находится PDF-файл:

Выполнить для всего документа:
...
Если вы хотите работать с диапазоном страниц, вы можете указать номер флага. 

`-l` (последняя страница), поэтому `-f 1 -l 30` укажет страницы от 1 до 30.
...
Разрешение по умолчанию для этой команды — 150 точек на дюйм. 

Увеличение этого значения приведет как к увеличению размера файла, так и к большей детализации.
