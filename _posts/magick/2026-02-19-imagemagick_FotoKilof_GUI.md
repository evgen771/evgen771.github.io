---
layout: post
title: ImageMagick. FotoKilof GUI for ImageMagick.
categories: Magick
---

<h3>Содержание</h3>

- [Посмотреть, скачать](#посмотреть-скачать)
- [Fotokilof - графический интерфейс для ImageMagick](#fotokilof---графический-интерфейс-для-imagemagick)
- [Примеры работы с FotoKilof](#примеры-работы-с-fotokilof)
- [Конвертация графики](#конвертация-графики)
- [Функциональность](#функциональность)
- [Координаты обрезки](#координаты-обрезки)
- [Положение текста](#положение-текста)
- [Виньетка](#виньетка)
- [Распологать](#распологать)
- [Обработка](#обработка)
- [Обработка](#обработка-1)
- [Установка и запуск](#установка-и-запуск)
- [Устанавливать](#устанавливать)
  - [Linux](#linux)
  - [Windows](#windows)
  - [MacOS](#macos)
  - [FreeBSD](#freebsd)
