...
- [Получите подробную информацию об этом же изображении](#получите-подробную-информацию-об-этом-же-изображении)
- [general](#general)
- [Добавление рамки, черно-белое и негатив](#добавление-рамки-черно-белое-и-негатив)
- [Как сделать из картинки негатив? Очень просто](#как-сделать-из-картинки-негатив-очень-просто)
- [Нужно из цветного изображения сделать черно-белое (хотя правильнее было бы сказать — монохромное)](#нужно-из-цветного-изображения-сделать-черно-белое-хотя-правильнее-было-бы-сказать--монохромное)
- [Оттенки серого](#оттенки-серого)
- [Изменение размера изображения до 100×100 пикселей с сохранением пропорций](#изменение-размера-изображения-до-100100-пикселей-с-сохранением-пропорций)
- [Размер изображения будет изменен ровно на 100×100 пикселей](#размер-изображения-будет-изменен-ровно-на-100100-пикселей)
- [Качество](#качество)
- [Изменение контрастности изображения достигается](#изменение-контрастности-изображения-достигается)
- [Нормализация](#нормализация)
- [Основные команды с использование convert](#основные-команды-с-использование-convert)
- [Сконвертировать ai(tiff, eps, pdf) в jpg](#сконвертировать-aitiff-eps-pdf-в-jpg)
- [Изменить формат всех изображений с png на jpg](#изменить-формат-всех-изображений-с-png-на-jpg)
- [Создаем PDF из JPEG](#создаем-pdf-из-jpeg)
- [Создаём превью для всех картинок в каталоге](#создаём-превью-для-всех-картинок-в-каталоге)
- [Сделать картинки в папке серыми](#сделать-картинки-в-папке-серыми)
- [Добавить текст 'Flower' на картинку](#добавить-текст-flower-на-картинку)
- [Разместить текст 'Flower' внизу, по центру, добавив прозрачный фон](#разместить-текст-flower-внизу-по-центру-добавив-прозрачный-фон)
