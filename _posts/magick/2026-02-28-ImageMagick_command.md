...
- [Команда отображения](#команда-отображения)
- [Команда конвертации](#команда-конвертации)
- [Команда монтажа](#команда-монтажа)
- [Команда конвертации](#команда-конвертации-1)
- [Команда монтажа](#команда-монтажа-1)
...
`ImageMagick` имеет обширную [документацию](https://imagemagick.org/script/index.php) , хотя на сайте мало примеров или результатов, и я думаю, что лучший способ учиться — экспериментировать и изменять различные настройки и параметры.
