...
- [Отобразить последовательность изображений в виде анимации:](#отобразить-последовательность-изображений-в-виде-анимации)
- [Контроль задержки (в миллисекундах) между кадрами](#контроль-задержки-в-миллисекундах-между-кадрами)
- [Зациклить анимацию определенное количество раз (используйте 0 для бесконечного цикла)](#зациклить-анимацию-определенное-количество-раз-используйте-0-для-бесконечного-цикла)
- [Команды](#команды)
  ...
  - [Пакетное конвертирование](#пакетное-конвертирование)
