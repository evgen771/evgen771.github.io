...
- [Установите imagemagick](#установите-imagemagick)
- [Вы можете использовать pdftoppm из poppler-utilsпакет для преобразования PDF в PNG](#вы-можете-использовать-pdftoppm-из-poppler-utilsпакет-для-преобразования-pdf-в-png)
- [Преобразование одной страницы или диапазона страниц PDF-файла](#преобразование-одной-страницы-или-диапазона-страниц-pdf-файла)
- [Указание разрешения конвертированного изображения](#указание-разрешения-конвертированного-изображения)
...
Все остальные параметры (такие как обрезка, оттенки серого и т. д.) можно посмотреть на сайте `ImageMagic`
...
Изменять {page} на номер страницы. 

Он имеет индекс 1, поэтому -f 1 будет первая страница.
...
Обратите внимание еще раз, что `.png` будет добавлено к `outputname` автоматически, поэтому нет необходимости включать расширение. 
...
Чтобы увеличить разрешение конвертированного PDF, добавьте параметры `-rx` {`resolution`} и `-ry` {`resolution`}. 
